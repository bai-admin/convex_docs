...
[Supported schedules](/docs/scheduling/cron-jobs.mdx#supported-schedules) below.

The third argument is the name of the public function or
[internal function](/docs/functions/internal-functions.mdx), either a
[mutation](/docs/functions/mutation-functions.mdx) or an
[action](/docs/functions/actions.mdx).
...
[Convex dashboard cron jobs view](/docs/dashboard/deployments/schedules.md#cron-jobs-ui).
...
[Error handling](/docs/scheduling/scheduled-functions.mdx#error-handling) for
scheduled functions.
